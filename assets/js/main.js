      ...
      countdown.each(function() {
        ...
        $countdown.countdown(finalDate, function(event) {
          $countdown.html(event.strftime(
            '<div class="countdown-container row justify-content-center"><div class="col-6 col-sm-auto border border-light rounded-2x ml-3 mb-3"><div class="countdown-item "><div class="number ">%-D</div><span class="title border-top border-light">الأيام</span></div></div><div class="col-6 col-sm-auto border border-light rounded-2x ml-3 mb-3"><div class="countdown-item"><div class="number">%H</div><span class="title border-top border-light">الساعات</span></div></div><div class="col-6 col-sm-auto border border-light rounded-2x ml-3 mb-3"><div class="countdown-item"><div class="number">%M</div><span class="title border-top border-light">الدقائق</span></div></div><div class="col-6 col-sm-auto border border-light rounded-2x ml-3 mb-3"><div class="countdown-item "><div class="number">%S</div><span class="title border-top border-light ">الثواني</span></div></div></div>'
          ));
        });
      });
    }
